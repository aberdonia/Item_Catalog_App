...
def index():
    if request.method == 'POST':
        newEntry = Item(name=request.form['name'],
...
def category(cat):
    ...
    # print cat.name
    print cat_items
    return render_template('index.html', cat=cat, cats=cats,
                           cat_items=cat_items)
...
def item(cat, item):
    ...
    print seller.name
    return render_template('index_items.html', item=item_grab, cat=cat,
...
def editItem(cat, item_id):
    ...
    if request.method == 'POST':
        ...
        return render_template('editItem.html', item=item_grab,
                               cat=cat, cats=cats)
